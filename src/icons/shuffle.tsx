...
export const ShuffleIcon = ({ color, size }: IconType) => {
  return (
    <svg
      version="1.1"
      id="Icons"
    ...
    >
      ...
      <g>
        <path
          d="M22.6,19.8c-0.3-0.2-0.7-0.3-1.1-0.1c-0.3,0.2-0.6,0.5-0.6,0.9V22c-3.3,0-6-2.7-6-6c0-4.4-3.6-8-8-8C6.4,8,6,8.4,6,9
        ...
        />
        <path
          d="M15.8,12.3c0.3,0,0.5-0.1,0.7-0.3c1.1-1.3,2.8-2,4.5-2v1.4c0,0.4,0.2,0.7,0.6,0.9c0.1,0.1,0.3,0.1,0.4,0.1
